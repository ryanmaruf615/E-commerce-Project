...
if(isset($_GET['delete'])){
  ...
  $_SESSION['success_flash'] ="User has been delected!";
...
if(isset($_GET['add'])){
  ...
  if(!empty($errors)){
    ...
    $_SESSION['success_flash']= 'User hasbeen added';
    header('Location:users.php');
  }
  }
?>
...
<div class="form-group col-md-6">
<label for ="nmae">Permissions</lable>
  <select class="form_control " name="permissions">
    <option value=""<?=(($permissions=='')?' selected':'');?>></option>
    <option value="eiditor"<?=(($permissions=='editor')?' selected':'');?>>Editor</option>
